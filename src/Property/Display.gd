...
@export var sort_name: String = "";
@export var text: String = "";
@export var iso_639_1: String = "";

func get_any_valid_str() -> String:
	var __strings: Array[String] = [header, alt, sort_name, text]
...
func _init(__header: String = "", __alt: String = "", __sort_name: String = "", \
		__text: String = "", __iso_639_1: String = "") -> void:
	self.header = __header
	self.alt = __alt
	self.text = __text
	self.sort_name = __sort_name
